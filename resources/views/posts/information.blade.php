...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <div class="information">
            <p>本サービス「LYRICS SEARCH」は、歌詞を検索し翻訳をするwebサイトです。
            外国語の習得をより楽しく、効果の高いものにするために制作しました。
           </p>
       
            <div class ="lessons">
                <div class="lesson">
                    <div class="lesson-icon">
                    <span class="fa-regular fa-hand-peace"></span>
                    </div>
                    <p>楽しく学べる
                    </p>
                </div>
                ...
                <div class="lesson">
                    <div class="lesson-icon">
                    <span class="fa-solid fa-drum"></span>
                    </div>
                    <p>英語のリズムを学ベる
                    </p>
                </div>
                ...
                <div class="lesson">
                    <div class="lesson-icon">
                    <span class="fa-regular fa-brain"></span>
                    </div>
                    <p>歌詞のフレーズを覚えやすい
                    </p>
                </div>
            ...
            ただし、注意点もあります。洋楽の歌詞には、文法的に間違っているものや、日常会話では使わない方がいいスラングなどが含まれていることがあります。覚えたフレーズが、正しいものかどうかは、必ず確認するように気をつけてください。</p>
            </p>           
